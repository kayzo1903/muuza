  ...
  try {
    ...
    return {
      ...
      store: primaryBusiness ? {
        ...
        rating: primaryBusiness.rating || 0, // Provide default if null
        totalSales: totalSales,
        isActive: !!(primaryBusiness.isOpen && primaryBusiness.status === "open"), // Ensure boolean
      } : null,
    };
  } catch (error) {
