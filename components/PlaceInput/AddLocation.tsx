  ...
  return (
    <form onSubmit={handleSaveLocation} className="w-full">
      <div className="relative max-w-md">
        <HiLocationMarker className="absolute left-3 top-7 transform -translate-y-1/2 text-[#00BF63] text-4xl" />
        <input
          type="text"
          value={searchValue}
        ...
        <Button type="submit" className="w-full text-xl h-14 bg-[#00BF63]">
          Add location
        </Button>
      </div>
    </form>
